...
<body>
    ...
    <div class="accTools" style="display: flex; flex-direction: row; justify-content: center; flex-wrap: nowrap; min-width: 0;">
        <div class="accessibility-controls" style="display: flex; flex-wrap: nowrap; gap: 2px;">
